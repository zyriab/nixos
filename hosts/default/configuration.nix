...
in
{
    ...
    environment.shellAliases = {
        nrb = "sudo nixos-rebuild switch --flake ~/nixos/#default";
        ned = "nvim ~/nixos/hosts/default/configuration.nix";
        hed = "nvim ~/nixos/hosts/default/home.nix";
        ll = "ls -l";
        lg = "lazygit";
        nst = "npm start";
        got = "go test ./...";
        qc = "qmk compile -e CONVERT_TO=promicro_rp2040 -km colemak-v1";
        brs = "browsh --startup-url search.nixos.org";
    };
